...
const PermissionGroupPermissions = sequelize.define('permission_group_permissions', {}, DEFAULT_MODEL_SETTINGS);
...
async function migrate() {
  try {
    ...
    await PermissionGroup.sync({ force: process.env.RECREATE_SCHEMA === 'true' });
    await PermissionGroupPermissions.sync({ force: process.env.RECREATE_SCHEMA === 'true' });
